...
'response.End
	...
	mymail.To = "aamir@matrix-solutions.net"
	'mymail.CC = "aamir@matrixpk.com"
	mymail.Subject ="Matrix Solutions - Enquiry Form"
	mymail.TextBody = strBody
	
	mymail.Configuration.Fields.Item("http://schemas.microsoft.com/cdo/configuration/sendusing", 2) '2 to send using SMTP over the network
    'Name or IP of remote SMTP server
    mymail.Configuration.Fields.Item("http://schemas.microsoft.com/cdo/configuration/smtpserver", "5.77.41.134")
    'Server port
