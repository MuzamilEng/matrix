                        ...
                        <main className="flex relative flex-col justify-center items-center w-full" key={index}>
                            <div className="flex justify-between p-[1.5vw] items-center w-full max-w-[90vw]">
                                ...
                                <section className="flex justify-evenly items-center w-full xl:max-w-[70vw] lg:max-w-[70vw] md:max-w-[70vw]">
                                        ...
                                        return (
                                            <main className="" key={index}>
                                                <div className="flex items-center cursor-pointer">
                                                    ...
                                                    <p className="text-[#152347] text-[1.5vw] xl:text-vw lg:text-vw md:text-vw capitalize fomt-medium">{list?.title}</p>
                                                    </Link>
                                                </div>
                                            </main>
                                        );
                                   ...
                                   {admin && admin === 'admin' ? <Link to='/cms' className="p-[0.7vw] bg-[#152347] hover:bg-[#1c2e5e] text-vw text-white w-fit rounded-md">Dashboard</Link>: !token && <Link to='/login' className="p-[0.7vw] bg-[#152347] hover:bg-[#1c2e5e] text-vw text-white w-fit rounded-md">Login</Link>}
                                </section>
                            </div>
                   </main>
                    );
